...
PRODUCTION_SIGNING_KEYCHAIN="$HOME/Library/Keychains/login.keychain-db"
PRODUCTION_RECEIPT_PATH="$HOME/Library/Application Support/MeetingRecorder/local-signing-receipt-v1"
